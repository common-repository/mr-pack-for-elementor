...
if ( ! class_exists( 'Exopite_Simple_Options_Framework_Field_group' ) ) {
	class Exopite_Simple_Options_Framework_Field_group extends Exopite_Simple_Options_Framework_Fields {
		...
		public function __construct( $field, $value = '', $unique = '', $config = array() ) {
			...
			$this->field['options'] = wp_parse_args( $options, $dmrpults );
			$this->group_title = ( isset( $this->field['options']['group_title'] ) ) ? $this->field['options']['group_title'] : $dmrpults['group_title'];
			$this->is_repeater  = ( isset( $this->field['options']['repeater'] ) ) ? (bool) $this->field['options']['repeater'] : $dmrpults['repeater'];
			$this->is_accordion = ( isset( $this->field['options']['accordion'] ) ) ? (bool) $this->field['options']['accordion'] : $dmrpults['accordion'];
			$this->is_accordion_closed = ( isset( $this->field['options']['closed'] ) ) ? (bool) $this->field['options']['closed'] : $dmrpults['closed'];
			$this->limit        = ( isset( $this->field['options']['limit'] ) ) ? (int) $this->field['options']['limit'] : $dmrpults['limit'];
			...
			if ( ! $this->is_repeater ) {
				...
				$this->is_cloneable = ( isset( $this->field['options']['cloneable'] ) ) ? (bool) $this->field['options']['cloneable'] : $dmrpults['cloneable'];
				$this->is_sortable  = ( isset( $this->field['options']['sortable'] ) ) ? (bool) $this->field['options']['sortable'] : $dmrpults['sortable'];
			}
		...
		public function output() {
			...
			foreach ( $fields as $field ) {
				...
				$field_dmrpult = ( isset( $field['dmrpult'] ) ) ? $field['dmrpult'] : '';

				// Set repeater dmrpult field fields as disabled,
