...
class MRPACK_Templates_Source extends Elementor\TemplateLibrary\Source_Base {

	/**
	 * Template prefix
	 */
	protected $template_prefix = 'mrp_';
	...
	public function get_id() {
		return 'mrp-templates';
	}

	public function get_title() {
		return __( 'mrp Templates', 'mrpack-templates' );
	}
	...
	public function get_items( $args = array() ) {
		...
		$url            ='https://library.mr-programer.ir/mrpack_elements/mrpack_elements.json';
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		$url        = 'https://library.mr-programer.ir/mrpack_elements/templates/' . $filename . '.json';
		$response   = wp_remote_get( $url, array( 'timeout' => 60 ) );
		$body       = wp_remote_retrieve_body( $response );
		$body       = json_decode( $body, true );
